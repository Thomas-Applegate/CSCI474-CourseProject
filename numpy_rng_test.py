...
from NistRng.nistrng import *

if __name__ == "__main__":
    # Generate the sequence of integers and pack it in its 8-bit representation
    # sequence: numpy.ndarray = numpy.random.randint(-128, 128, math.floor((10**5)/8), dtype=int)
    sequence = numpy.random.randint(-128,128, 1000)
    sequence = numpy.append(sequence, numpy.array([0]*10))
    #
